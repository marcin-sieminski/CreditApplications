...
public class DepartmentRepository : IRepository<Department>
{
    ...
    private readonly DbSet<Department> _entities;

    public DepartmentRepository(CreditApplicationsDbContext context)
    {
        _context = context;
        _entities = context.Set<Department>();
    }
    ...
    public async Task<int> Update(Department entity)
    {
        ...
        var dbEntity = _context.Departments.AsNoTracking().FirstOrDefault(x => x.Id == entity.Id);
